...
public class MktmpioBaseTest {
    @ClassRule
    public static WireMockRule wireMockRule = new WireMockRule(0); // No-args constructor defaults to port 8080

    public static String mockedServer() {
        return "http://127.0.0.1:" + wireMockRule.port();
    }

    public static void prepareToRejectUnauthorized(final String token, final String type) {
    ...
    public static void prepareFakeInstance(final String token, final String type) {
